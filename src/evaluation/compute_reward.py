...
def parse_arguments():
    ...
    parser.add_argument(
        '--path',
        default='results/FedPA_0.5help_0.5harm/',
        type=str,
        help='',
    )
...
model_path_helpful = '/path/to/model_cache/model--PKU-Alignment--beaver-7b-v1.0-reward'
model_path_harmless = '/path/to/model_cache/model--PKU-Alignment--beaver-7b-v1.0-cost'
